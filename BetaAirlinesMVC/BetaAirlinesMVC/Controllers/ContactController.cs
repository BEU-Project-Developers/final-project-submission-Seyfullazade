...
namespace BetaAirlinesMVC.Controllers
{
    public class ContactController : Controller
    {
        ...
        public ActionResult Index([Bind(Include = "Id,Name,Email,Subject,Message,Date,Active")] Contact contact)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Email,Subject,Message,Date,Active")] Contact contact)
        {
            if (ModelState.IsValid)
            {
